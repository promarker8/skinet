...
export class CheckoutPaymentComponent implements OnInit {
  ...
  ngOnInit(): void {
    loadStripe("pk_test_51OcWSmJX3DWWXjrVzUB9HCIuigqwqRyJiUhTmUecRlaYYX8qX5irDT58w1NY6Kw89CisPuohpx2u7oor9m1wKNGp00LoyFzIYR").then(stripe => {
      this.stripe = stripe;
  ...
  // guaranteeing that this method will return a type OrderToCreate NOT undefined
  // this is done so the create order method etc can run smoother, without optional chaining etc
